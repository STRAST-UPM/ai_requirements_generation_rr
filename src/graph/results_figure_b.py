...
p_center = np.array([0.9306, 0.7897, 0.8794, 0.6317, 0.5439, 0.7830, 0.5966, 0.7414, 0.7164, 0.7830, 0.7414, 0.6024, 0.7971, 0.5966, 0.7287])
p_low =    np.array([0.8860, 0.7148, 0.8204, 0.5424, 0.4516, 0.7073, 0.5057, 0.6607, 0.6332, 0.7073, 0.6607, 0.5117, 0.7233, 0.5057, 0.6467])
p_high =   np.array([0.9753, 0.8646, 0.9383, 0.7210, 0.6362, 0.8588, 0.6875, 0.8221, 0.7997, 0.8588, 0.8221, 0.6931, 0.8709, 0.6875, 0.8107])

r_best_center = np.array([0.4619, 0.3221, 0.3348, 0.5508, 0.2459, 0.3094, 0.3221, 0.2078, 0.2840, 0.3094, 0.2840, 0.2713, 0.2840, 0.2078, 0.1951])
r_best_low =    np.array([0.3695, 0.2357, 0.2475, 0.4586, 0.1665, 0.2240, 0.2357, 0.1332, 0.2007, 0.2240, 0.2007, 0.1893, 0.2007, 0.1332, 0.1224])
r_best_high =   np.array([0.5543, 0.4085, 0.4221, 0.6430, 0.3252, 0.3949, 0.4085, 0.2823, 0.3673, 0.3949, 0.3673, 0.3533, 0.3673, 0.2823, 0.2678])

r_worst_center = np.array([0.4111, 0.2713, 0.2967, 0.5381, 0.1569, 0.2713, 0.2586, 0.1697, 0.2078, 0.2459, 0.1697, 0.1697, 0.2332, 0.1824, 0.1569])
r_worst_low =    np.array([0.3199, 0.1893, 0.2123, 0.4457, 0.0906, 0.1893, 0.1779, 0.1010, 0.1332, 0.1665, 0.1010, 0.1010, 0.1553, 0.1116, 0.0906])
r_worst_high =   np.array([0.5022, 0.3533, 0.3811, 0.6305, 0.2233, 0.3533, 0.3393, 0.2383, 0.2823, 0.3252, 0.2383, 0.2383, 0.3110, 0.2531, 0.2233])
